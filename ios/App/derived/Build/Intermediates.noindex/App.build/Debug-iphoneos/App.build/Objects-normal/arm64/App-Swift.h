...
@class NSBundle;
@class NSCoder;
SWIFT_RESILIENT_CLASS("_TtC3App26CustomBridgeViewController")
@interface CustomBridgeViewController : CAPBridgeViewController
...
SWIFT_CLASS_NAMED("TimerBridgePlugin")
@interface TimerBridgePlugin : CAPPlugin <CAPBridgedPlugin>
...
- (void)setTimer:(CAPPluginCall * _Nonnull)call;
- (void)clearTimer:(CAPPluginCall * _Nonnull)call;
